...
export type EvolutionNode = {
    ...
    id: number;
    sprite: string;
    requirement?: z.infer<typeof EvolutionRequirementSchema> | undefined;
    children: EvolutionNode[];
};

export const EvolutionNodeSchema: z.ZodType<EvolutionNode> = z.lazy(() => z.object({
	...
	children: z.array(EvolutionNodeSchema),
...
export const PokemonSchema = z.object({
	...
	evolutions: EvolutionNodeSchema.nullable().openapi({ description: 'Evolution chain as a tree' }),
}).openapi('Pokemon');
...
export const PokemonPageSchema = z.object({
	...
	pokemon: z.array(PokemonSchema).openapi({ description: 'List of Pokemon on this page' }),
}).openapi('PokemonPage');
