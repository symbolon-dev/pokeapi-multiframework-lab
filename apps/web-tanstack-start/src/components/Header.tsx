...
export default function Header() {
    ...
    return (
        <>
            <header className={`
                flex items-center bg-gray-800 p-4 text-white shadow-lg
            `}
            >
                <button
            ...
            <aside
                className={`
                    fixed top-0 left-0 z-50 flex h-full w-80 transform flex-col
                    bg-gray-900 text-white shadow-2xl transition-transform
                ...
                'flex items-center gap-3 p-3 rounded-lg bg-cyan-600 hover:bg-cyan-700 transition-colors mb-2',
                    ...
                    <div className="flex flex-row justify-between">
                        <Link
                            ...
                            onClick={() => setIsOpen(false)}
                            className={`
                                mb-2 flex flex-1 items-center gap-3 rounded-lg
