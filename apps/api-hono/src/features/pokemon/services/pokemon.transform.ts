import type { PokemonData, PokemonDetails, TypeDetails, TypeDetailsApi } from '../schemas/pokemon.types';

import { extractDominantColor } from '@/lib/color';
import { ALL_TYPES } from './pokemon.cache';
import { mapEvolutionChain } from './pokemon.evolution';
