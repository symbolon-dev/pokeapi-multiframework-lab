import type { EvolutionChain, EvolutionRequirement, MappedEvolution, PokemonData, PokemonDetails, TypeDetails, TypeDetailsApi } from '@/types/pokemon';
...
function mapEvolutionChain(chain: EvolutionChain): MappedEvolution {
