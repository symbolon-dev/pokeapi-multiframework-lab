...
export default function Home() {
    return (
        ...
        >
            <main className={`
                flex min-h-screen w-full max-w-3xl flex-col items-center
                justify-between bg-white px-16 py-32
                sm:items-start
                dark:bg-black
            `}
            >
                ...
                >
                    <a
                        className={`
                            bg-foreground text-background flex h-12 w-full
                            items-center justify-center gap-2 rounded-full px-5
                            transition-colors
                            hover:bg-[#383838]
                            md:w-39.5
                            dark:hover:bg-[#ccc]
